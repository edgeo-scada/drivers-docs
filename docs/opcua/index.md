...
[![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://github.com/edgeo-scada/drivers/opcua/blob/main/LICENSE)
[![GitHub](https://img.shields.io/badge/github-repo-black.svg?logo=github)](https://github.com/edgeo-scada/drivers/opcua)
...
```bash
go get github.com/edgeo-scada/drivers/opcua@v1.0.0
```

To verify the installed version:

```go
import "github.com/edgeo-scada/drivers/opcua"
