...
|----------|---------|-------------|
| [Modbus TCP](/modbus/) | `github.com/edgeo-scada/drivers/modbus` | Industrial standard for PLC communication (FC01-FC17) |
| [OPC UA](/opcua/) | `github.com/edgeo-scada/drivers/opcua` | Unified Architecture with sessions, subscriptions, and security |
| [MQTT](/mqtt/) | `github.com/edgeo-scada/drivers/mqtt` | MQTT 5.0 client with TLS, WebSocket, and connection pooling |
| [S7](/s7/) | `github.com/edgeo-scada/drivers/s7` | Siemens S7comm for S7-200/300/400/1200/1500/LOGO! |
| [BACnet](/bacnet/) | `github.com/edgeo-scada/drivers/bacnet` | BACnet/IP for building automation with COV and discovery |
| [SNMP](/snmp/) | `github.com/edgeo-scada/drivers/snmp` | SNMP v1/v2c/v3 with trap listener and MIB walk |
...
go get github.com/edgeo-scada/drivers/opcua
